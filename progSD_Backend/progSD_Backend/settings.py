"""
Django settings for progSD_Backend project.
...
SECRET_KEY = 'django-insecure-l@zae_d+po+nf)xdz9erw&07$j*^km&p5k4u=n^q%m(9*+xnn!'
...
WSGI_APPLICATION = 'progSD_Backend.wsgi.application'
